    ...
    >
      <g className={`${styles.scooter} ${styles[state]}`}>
        ...
        <circle
          ...
          r="3"
          fill="#1a1a1a"
          className={`${styles.wheel} ${styles[state]}`}
      ...
      <g
        className={`${styles.cheesePop} ${styles[state]}`}
        style={{ transformOrigin: "28px 13px" }}
      >
        <circle cx="28" cy="13" r="4.5" fill="#ffcc02" />
        <path
          d="M26 13 Q27.5 11 28 13 Q28.5 11 30 13"
          stroke="#e65100"
          strokeWidth="0.8"
          fill="none"
        />
      ...
      <path
        ...
        fill="none"
        strokeLinecap="round"
        className={`${styles.steam} ${styles[state]}`}
      />
      <path
        d="M31 10 Q33 7 31 5"
        stroke="#ff9800"
        ...
        fill="none"
        strokeLinecap="round"
        className={`${styles.steam} ${styles[state]} ${styles.sd1}`}
      />
    </svg>
  );
