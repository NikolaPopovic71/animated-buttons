...
export function BookButton({ onComplete }: BookButtonProps) {
  ...
  const icon = (
    ...
    >
      ...
      {/* Book body */}
      <g
        className={`${styles.book} ${styles[state]}`}
        ...
        {state === "running" && (
          <>
            ...
            <line
              ...
              stroke="#ccc"
              strokeWidth="0.5"
              className={`${styles.pageLine} ${styles.pl1}`}
            />
            <line
              x1="12"
              y1="23"
              ...
              stroke="#ccc"
              strokeWidth="0.5"
              className={`${styles.pageLine} ${styles.pl2}`}
            />
          </>
        )}
      </g>
      ...
      {state === "done" && (
        <>
          ...
          <circle
            ...
            r="1"
            fill="#ffd56b"
            className={`${styles.sparkle} ${styles.sp1}`}
          />
          <circle
            cx="30"
            cy="28"
            r="1.2"
            fill="#ffd56b"
            className={`${styles.sparkle} ${styles.sp2}`}
          />
        </>
      )}
    </svg>
