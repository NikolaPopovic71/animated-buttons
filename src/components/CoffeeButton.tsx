...
export function CoffeeButton({ onComplete }: CoffeeButtonProps) {
  ...
  const icon = (
    ...
    >
      ...
      />
      <path
        d="M10 16 L10 30 Q10 33 13 33 L23 33 Q26 33 26 30 L26 16 Z"
        fill="#4e342e"
      />
      <clipPath id="cupClip">
      ...
      />
      <path
        d="M26 20 Q31 20 31 24 Q31 28 26 28"
        stroke="#5d4037"
        strokeWidth="2"
        fill="none"
        strokeLinecap="round"
      ...
      {state === "running" && (
        <>
          ...
          <line
            ...
            strokeWidth="1.2"
            strokeLinecap="round"
            className={`${styles.drip} ${styles.d1}`}
          />
          <line
            x1="22"
            y1="7"
            ...
            strokeWidth="1.2"
            strokeLinecap="round"
            className={`${styles.drip} ${styles.d2}`}
          />
        </>
      )}
      {state === "done" && (
        <>
          ...
          <ellipse
            ...
            ry="1.2"
            fill="#6d4c41"
            className={`${styles.bean} ${styles.b1}`}
          />
        </>
      )}
    </svg>
